...
Current focus areas: Home loans, construction loans, plot loans, renovation loans, balance transfers, and housing finance regulations."""
    ...
    def generate_response(self, user_question: str, context_chunks: List[Dict[str, Any]]) -> str:
        """
...
Please provide a comprehensive and accurate answer based on the context provided. If the context doesn't contain enough information to fully answer the question, acknowledge this and provide what information you can."""
    ...
    def chat(self, user_question: str) -> Dict[str, Any]:
        ...
        try:
            ...
            context_chunks = self.search_relevant_context(user_question, self.max_context_chunks)
            
            # Determine if we should use RAG or fallback to general knowledge
            use_rag = len(context_chunks) > 0 and any(chunk['score'] > 0.8 for chunk in context_chunks)
            ...
            result = {
                ...
                'context_sources': [chunk['source'] for chunk in context_chunks] if use_rag else [],
            ...
            logger.info(f"Generated response using {response_source} with {len(context_chunks)} context chunks")
            return result
...
Please provide a helpful response based on your general financial knowledge. Be clear about what you know and what might require professional consultation."""
            ...
            response = self.client.chat.completions.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": fallback_prompt.format(question=user_question)},
...
def interactive_chat():
    ...
    try:
        ...
        print("I can help you with questions about housing finance, home loans, and ABC Housing Finance Limited.")
