...
def main():
    ...
    with st.sidebar:
        # Logo
        st.image("Screenshot_2025-07-16_at_6.34.27_PM-removebg-preview copy.png", width=150)
        st.markdown("---")
    ...
    if st.session_state.messages:
        ...
        for message in st.session_state.messages:
            if message["role"] == "user":
                ...
                if message.get('relevant_chunks') and len(message['relevant_chunks']) > 0:
    ...
    if not st.session_state.messages:
        ...
        st.markdown("I'm here to help you with questions about housing finance, home loans, and financial planning")
        ...
        st.markdown("---")
        st.markdown("*Start by asking a question or use the quick suggestions in the sidebar!*")
    ...
    with col2:
        ...
        if user_input:
            ...
            send_button = st.button("🚀 Send Message", use_container_width=True, disabled=True)
